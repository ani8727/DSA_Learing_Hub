...
import { Layers, Sparkles, ListChecks } from 'lucide-react';

const sections = [
  {
    title: 'Sorting Overview',
    desc: 'Core ideas, types, and why sorting matters.',
    icon: <Layers size={26} color="#3b5bdb" />, 
    link: '/patterns/sorting/overview',
    color: '#f4f6fb',
  },
  {
    title: 'Sorting Tricks & Patterns',
    desc: 'Key tricks, custom comparators, and advanced patterns.',
    icon: <Sparkles size={26} color="#388e3c" />, 
    link: '/patterns/sorting/tricks',
    color: '#f3f8f3',
  },
  {
    title: 'Practice Problems',
    desc: 'Curated sorting problems to master patterns.',
    icon: <ListChecks size={26} color="#b26a00" />, 
    link: '/patterns/sorting/problems',
    color: '#fdf7ed',
  },
];
...
const SortingIndex = () => (
  <div className="topic-page" style={{ maxWidth: 700, margin: '0 auto', padding: '32px 8px 32px 8px', background: '#f8fafc', borderRadius: 18 }}>
    <h1 style={{ fontSize: 32, fontWeight: 700, color: '#253858', marginBottom: 28, textAlign: 'center', letterSpacing: 0.5 }}>Sorting Patterns</h1>
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 40 }}>
      ...
      <Link to="/patterns/sorting/overview" style={{ background: '#3b5bdb', color: '#fff', padding: '10px 22px', borderRadius: 8, fontWeight: 500, textDecoration: 'none', border: 'none', boxShadow: '0 1px 4px #e3e7ef', transition: 'background 0.2s' }}>
        Start Learning &rarr;
      </Link>
    </div>
  </div>
